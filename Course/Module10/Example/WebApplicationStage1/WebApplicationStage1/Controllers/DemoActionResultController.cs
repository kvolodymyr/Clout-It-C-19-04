...
namespace WebApplicationStage1.Controllers
{
    public class DemoActionResultController : Controller
    {
        // GET: DemeActionResult
        public ActionResult Index()
        {
            ...
            ViewBag.Actions = new Dictionary<string, string> {
                ...
                { "EmptyResult", "DemoEmptyResult" },
                { "ContentResult", "DemoContentResult" },
                { "FileContentResult", "DemoFileContentResult" },
                { "FilePathResult", "DemoFilePathResult" },
                { "FileStreamResult", "DemoFileStreamResult" },
                { "JavaScriptResult", "DemoJavaScriptResult" },
                { "JsonResult", "DemoJsonResult"},
                { "RedirectResult", "DemoRedirectResult"},
                { "RedirectToRouteResult", "DemoRedirectToRouteResult"},
                { "StatusResult-UnauthorizedByDefault", "DemoStatusResult" },
                { "PartialViewResult", "DemoPartialViewResult"},
                { "HttpUnauthorizedResult", "DemoHttpUnauthorizedResult"}
            };

            return View();
        }

        public ActionResult DemoViewResult() {
            return View();
        }

        public ActionResult DemoEmptyResult() {
            return new EmptyResult();
        }

        public ActionResult DemoContentResult() {
            return Content("this is some text");
        }

        public ActionResult DemoFileContentResult() {
            // File.ReadAllBytes
            using (StreamReader sr = new StreamReader(Server.MapPath("/Data/template.txt")))
                return File(Encoding.ASCII.GetBytes(sr.ReadToEnd()), System.Net.Mime.MediaTypeNames.Application.Octet, "template.txt");
        }

        public ActionResult DemoFilePathResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoFileStreamResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoJavaScriptResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoJsonResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoRedirectResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoRedirectToRouteResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoPartialViewResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoStatusResult()
        {
            ////
            //// Summary:
        ...
        public ActionResult DemoHttpUnauthorizedResult()
        {
            throw new NotImplementedException();
        }

        public ActionResult DemoNotFound()
        {
            throw new NotImplementedException();
        }
